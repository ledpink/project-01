...
namespace ZipFileModule
{
    ...
    public class EncParsing2
    {
        ...
        private EncParsing2(string encPath, string datPath)
        {
            _encPath = encPath;
            _datPath = datPath;
        }

        public static EncParsing2 Create(string encPath, string datPath)
        {
            return new EncParsing2(encPath, datPath);
        }
